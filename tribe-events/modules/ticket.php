	...
	<div class="buy-ticket">
		...
		<div class="col-xs-5 col-sm-3 labels">
			<div class="label qty">
				...
				<span>(<?php echo $ticket->get_regular_price(); ?>ZŁ/BILET)</span>
			</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-5 reserve">
			<a class="btn frame-btn reserve-btn glow" href="/rezerwacja/?date=<?php echo substr($post->EventStartDate, 0, 10)?>">Bilet z rezerwacją miejsc siedzących</a>
		</div>
	</div>
